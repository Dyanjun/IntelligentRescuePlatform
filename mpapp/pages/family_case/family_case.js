...
Page({
  ...
  addLoser() {
    wx.navigateTo({
      url: '/pages/add_loser/add_loser?family_id=' + this.data.familyId,
    })
  },
              ...
              success (res) {
                ...
                wx.request({
                  ...
                  success (res) {
                    ...
                    wx.navigateTo({
                      url: '/pages/family_case_detail/family_case_detail?familyId=' + that.data.familyId + '&list=' + encodeURIComponent(JSON.stringify(caseDetail)),
                    })
                  }
                })
              }
  ...
  submit() {
    ...
    wx.navigateTo({
      url: '/pages/family_case_submit/family_case_submit?familyId=' + this.data.familyId,
    })
  }
})
