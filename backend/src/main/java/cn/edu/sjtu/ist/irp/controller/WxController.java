...
public class WxController {
    ...
    @GetMapping("/code")
    public void getCode(@RequestParam(value="code") String code, @RequestParam(value="username") String username){
        ...
        WxUtil.addOpenid(username, openid);
    }
    ...
    public String SendMessage() {
        ...
        t.setTouser("0435Ccml2vhki84oVXml2Zl1hV15Ccm0");//根据上面我写的方法自行获取
